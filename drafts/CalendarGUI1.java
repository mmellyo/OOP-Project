// NOUVELLE VERSION J'AI MODIFIER LA PARIE DU TITRE DE LA FENETRE POUR LE CALENDRIER
// CETTE MODIFICATION PERMET DE CREE UN CALENDRIER QU'ON DEFINIT LE TITRE DE SA FENETRE DANS LE CODE 
...
public class CalendarGUI {
    ...
    private String title; // Add of an attribut for the title of the window

    // Constructor which initializes the interface by receiving an instance of CalendarINFO
    public CalendarGUI(CalendarINFO calendarInfo, String title) {
    ...
    protected void createGUI() {
        // Main Window
        JFrame frame = new JFrame(title); // Creation of the JFrame window with a title "Medical Calendar"
