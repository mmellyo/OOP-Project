...
//                 for (Patient temPatient : patientRecords) {
//                     if (temPatient.getName().equalsIgnoreCase(firstName) && temPatient.getLastName().equalsIgnoreCase(lastName)) {
//                         //if existant patient -> display his infos
//                         handleFoundPatient(temPatient);
...
//      //****************************DELETING LOGIC ************************//
//     private static void createRightClickMenu(JList<String> patientList) {
...
//                 deletePatientFromFile(selectedPatient);
//             } else {
...
//                 if (e.isPopupTrigger()) {
//                     patientList.setSelectedIndex(patientList.locationToIndex(e.getPoint()));
//                     popupMenu.show(patientList, e.getX(), e.getY());
//                 }
//             }
...
//     private static void deletePatientFromFile(String patientInfo) {
//         File file = new File("patients.txt");
//         File tempFile = new File("temp_patients.txt");
...
//                 if (!line.contains(patientInfo)) { // Skip the patient being deleted
//                     writer.write(line + System.lineSeparator());
//                 }
//             }
//         } catch (IOException ex) {
//             ex.printStackTrace();
//             JOptionPane.showMessageDialog(null, "Error deleting patient!", "Error", JOptionPane.ERROR_MESSAGE);
//             return;
//         }
...
//         } else {
//             JOptionPane.showMessageDialog(null, "Failed to update file!", "Error", JOptionPane.ERROR_MESSAGE);
//         }
//     }
...
//             writer.println("ID: " + patient.getId());
//             writer.println("Name: " + patient.getName());
//             writer.println("Last Name: " + patient.getLastName());
//             writer.println("Phone Number: " + patient.getPhoneNumber());
//             writer.println("Date of Birth: " + patient.getDateOfBirth());
//             writer.println("Observation: " + patient.getObservation());
//             writer.println("Diagnostic: " + patient.getDiagnostic());
//             writer.println("Prescription: " + patient.getPrescription());
//         } catch (IOException e) {
//             e.printStackTrace();
//         }
//     }
...
//             String observation = br.readLine().split(": ")[1];
//             String diagnostic = br.readLine().split(": ")[1];
//             String prescription = br.readLine().split(": ")[1];

//             return new Patient(id, name, lastName, phoneNumber, dateOfBirth, observation, diagnostic, prescription);
